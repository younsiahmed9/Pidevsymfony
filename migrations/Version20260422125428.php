 ...
 */
final class Version20260422125428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX idx_clients_city ON clients');
        ...
        $this->addSql('ALTER TABLE portefeuille DROP FOREIGN KEY fk_portefeuille_user');
        $this->addSql('ALTER TABLE portefeuille DROP FOREIGN KEY fk_portefeuille_user');
        ...
        $this->addSql('DROP INDEX idx_portefeuille_user ON portefeuille');
        ...
        $this->addSql('ALTER TABLE virement_programme DROP FOREIGN KEY fk_virement_user');
        ...
        $this->addSql('DROP INDEX idx_virement_user ON virement_programme');
