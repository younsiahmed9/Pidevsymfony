...
class DocumentController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $em, SluggerInterface $slugger, UtilisateurRepository $userRepo): Response
    {
        ...
        return $this->render('user/document/new.html.twig', ['document' => $document, 'form' => $form]);
    }

    #[Route('/{id}', name: 'user_document_show', methods: ['GET'])]
    public function show(Document $document): Response
    {
        return $this->render('user/document/show.html.twig', ['document' => $document]);
    }
    ...
    public function edit(Request $request, Document $document, EntityManagerInterface $em, SluggerInterface $slugger): Response
    {
        ...
        return $this->render('user/document/edit.html.twig', ['document' => $document, 'form' => $form]);
    }

    #[Route('/{id}/delete', name: 'user_document_delete', methods: ['POST'])]
