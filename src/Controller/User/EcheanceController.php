...
{
    #[Route('/', name: 'user_echeance_index', methods: ['GET'])]
    public function index(Request $request, EcheanceRepository $repo): Response
    {
        ...
        return $this->render('user/echeance/index.html.twig', [
    ...
    #[Route('/new', name: 'user_echeance_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $em, UtilisateurRepository $userRepo): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('user_echeance_index');
        }
        return $this->render('user/echeance/new.html.twig', ['echeance' => $echeance, 'form' => $form]);
    }

    #[Route('/{id}', name: 'user_echeance_show', methods: ['GET'])]
    public function show(Echeance $echeance): Response
    {
        return $this->render('user/echeance/show.html.twig', ['echeance' => $echeance]);
    }

    #[Route('/{id}/edit', name: 'user_echeance_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Echeance $echeance, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('user/echeance/edit.html.twig', ['echeance' => $echeance, 'form' => $form]);
    }

    #[Route('/{id}/delete', name: 'user_echeance_delete', methods: ['POST'])]
