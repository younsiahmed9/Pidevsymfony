...
{
    #[Route('/', name: 'admin_dossier_index', methods: ['GET'])]
    public function index(Request $request, DossierRepository $repo): Response
    {
        ...
        return $this->render('admin/dossier/index.html.twig', [
            'dossiers' => $repo->search($query),
            'q'        => $query,
        ]);
    }

    #[Route('/new', name: 'admin_dossier_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $em, UtilisateurRepository $userRepo): Response
    {
        ...
        return $this->render('admin/dossier/new.html.twig', ['dossier' => $dossier, 'form' => $form]);
    }

    #[Route('/{id}', name: 'admin_dossier_show', methods: ['GET'])]
    public function show(Dossier $dossier): Response
    {
        return $this->render('admin/dossier/show.html.twig', ['dossier' => $dossier]);
    }

    #[Route('/{id}/edit', name: 'admin_dossier_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Dossier $dossier, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('admin/dossier/edit.html.twig', ['dossier' => $dossier, 'form' => $form]);
    }

    #[Route('/{id}/delete', name: 'admin_dossier_delete', methods: ['POST'])]
