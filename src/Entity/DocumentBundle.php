...
#[ORM\Entity(repositoryClass: DocumentBundleRepository::class)]
...
class DocumentBundle
{
    ...
    #[ORM\ManyToMany(targetEntity: Document::class, inversedBy: 'bundles')]
    ...
    public function getNomBundle(): string { return $this->nomBundle; }
    public function setNomBundle(string $nomBundle): static { $this->nomBundle = $nomBundle; return $this; }
